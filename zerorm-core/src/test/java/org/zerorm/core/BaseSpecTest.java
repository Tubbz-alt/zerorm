...
/**
 * A Test being adapted from OpenHMS SqlBuilder:
 * https://svn.code.sf.net/p/openhms/code/sqlbuilder/tags/sqlbuilder-2.0.12/src/test/java/com/healthmarketscience/sqlbuilder/SqlBuilderTest.java
 * @author bvan
*/ 
public class BaseSpecTest extends TestCase {
    
    protected Table _table1;
    protected Column _table1_col1;
    protected Column _table1_col2;
    protected Column _table1_col3;
    protected Table _defTable1;
    protected Column _defTable1_col_id;
    protected Column _defTable1_col2;
    protected Column _defTable1_col3;
    protected Table _defTable2;
    protected Column _defTable2_col_id;
    protected Column _defTable2_col4;
    protected Column _defTable2_col5;

    protected Expr _idJoinExpr;
    protected Expr _col4JoinExpr;

    public BaseSpecTest(){
        _table1 = new Table( "Table1" );

        _table1_col1 = _table1.$( "col1", String.class );
        _table1_col2 = _table1.$( "col2", Number.class );
        _table1_col3 = _table1.$( "col3", Double.class );
        _defTable1 = new Table( "Table1" );
        _defTable1_col_id = _defTable1.$( "col_id", Number.class );
        _defTable1_col2 = _defTable1.$( "col2", String.class );
        _defTable1_col3 = _defTable1.$( "col3", Date.class );
        _defTable2 = new Table( "Table2" );
        _defTable2_col_id = _defTable2.$( "col_id", Number.class );
        _defTable2_col4 = _defTable2.$( "col4", String.class );
        _defTable2_col5 = _defTable2.$( "col5", Date.class );

        _table1.$( "col4", String.class );
        _defTable1.$( "altCol4", String.class );

        _idJoinExpr = _defTable1_col_id.eq( _defTable2_col_id );
    }
    ...
    public void testInsert(){
        String insertStr1 = new Insert( _table1 )
                .columns( _table1_col1, _table1_col3, _table1_col2 )
                .values( 13, "feed me seymor", true ).formatted();
        checkResult( insertStr1,
                "INSERT INTO Table1 ( col1, col3, col2 ) VALUES ( 13, 'feed me seymor', 1 )" );

        String insertStr2 = new Insert( _table1 )
                .columns( _table1_col1, _table1_col2, _table1_col3 )
                .values( "13", _table1_col2.checkedParam(), _table1_col3.checkedParam() ).
                formatted();

        checkResult( insertStr2,
                "INSERT INTO Table1 ( col1, col2, col3 ) VALUES ( '13', ?, ? )" );
    /*
